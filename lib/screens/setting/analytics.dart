...
import 'package:vibe_tag/screens/setting/overall.dart';
              ...
              children: [
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: _currentIndex==0?Color(0xff485470):Color(0xffF1F4FB)
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(26),
                        color: _currentIndex==1?Color(0xff485470):Color(0xffF1F4FB)
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(26),
                        color: _currentIndex==2?Color(0xff485470):Color(0xffF1F4FB)
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(26),
                        color: _currentIndex==3?Color(0xff485470):Color(0xffF1F4FB)
