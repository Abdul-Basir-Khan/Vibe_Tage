...
import 'package:vibe_tag/screens/verification/request_link.dart';
      ...
      body: Padding(
        ...
        child: ListView(
          ...
          children: [
            ...
            const ReusableText(title: 'Step 2',size: 13,weight: FontWeight.w600,color: Color(0xffFF9200),),
            const SizedBox(height: 15,),
            const ReusableText(title: 'Confirm Notability',size: 18,weight: FontWeight.w700,color: Color(0xff212121),),
            const SizedBox(height: 10,),
            const ReusableText(title: 'Show that the publics figure, celebrity or brand your\naccount represents is in the public interest',size: 12,weight: FontWeight.w400,color: Color(0xff7D8CAC),),
            const SizedBox(height: 15,),
            TextField(
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              const ReusableText(title: 'News/Media',size: 16,weight: FontWeight.w600,color: Color(0xff212121),),
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              const ReusableText(title: 'Sports',size: 16,weight: FontWeight.w600,color: Color(0xff212121),),
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              const ReusableText(title: 'Government and Politics',size: 16,weight: FontWeight.w600,color: Color(0xff212121),),
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              const ReusableText(title: 'Music',size: 16,weight: FontWeight.w600,color: Color(0xff212121),),
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              const ReusableText(title: 'Entertainment',size: 16,weight: FontWeight.w600,color: Color(0xff212121),),
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              const ReusableText(title: 'Digital Creator/Blogger',size: 16,weight: FontWeight.w600,color: Color(0xff212121),),
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              const ReusableText(title: 'Gamer',size: 16,weight: FontWeight.w600,color: Color(0xff212121),),
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              const ReusableText(title: 'Treveler',size: 16,weight: FontWeight.w600,color: Color(0xff212121),),
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              const ReusableText(title: 'Other',size: 16,weight: FontWeight.w600,color: Color(0xff212121),),
            ...
            const SizedBox(height: 10,),
            const ReusableText(title: 'Who follows you, why, and their interests',size: 12,weight: FontWeight.w400,color: Color(0xff7D8CAC),),
            const SizedBox(height: 10,),
            TextField(
              style: const TextStyle(color: Colors.black),
              decoration: InputDecoration(
            ...
            Row(
              children: [
                ...
                InkWell(
                  onTap: (){
                    setState(() {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>const RequestLink()));
                    });
                  },
                  child: Container(
                    height: 50,
