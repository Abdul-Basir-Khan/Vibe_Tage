...
import 'package:vibe_tag/screens/register/pre_registeration/screen_three.dart';
        ...
        Padding(
          ...
          child: Center(
            child: Column(
              ...
              const Spacer(),
              const Image(image: AssetImage("Asset/images/log_in_sign_up/Group 1000002111.png")),
              ...
              const ReusableText(title: 'Share Your Vibe',weight: FontWeight.w700,size: 24,color: Color(0xff212121),),
              const SizedBox(height: 10,),
