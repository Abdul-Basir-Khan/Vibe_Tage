...
import 'package:vibe_tag/screens/register/splash_screen/congrats_splash.dart';
            ...
            child: Column(
              ...
              SizedBox(
                ...
                child: InkWell(
                  onTap: (){
                    setState(() {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>CongratsSplashScreen()));
                    });
                  },
                  child: Container(
                    height: 50,
