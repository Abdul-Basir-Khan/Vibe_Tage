...
import 'package:vibe_tag/screens/register/follow.dart';
import 'package:vibe_tag/screens/register/identity.dart';
            ...
            children: [
             ...
             Center(
               child: CircleAvatar(
                 ...
                 child: Center(
                   child: IconButton(
                     icon: Icon(Icons.camera_alt_outlined,color: Color(0xff7D8CAC),size: 70,),
                     onPressed: (){
                       // setState(() {
